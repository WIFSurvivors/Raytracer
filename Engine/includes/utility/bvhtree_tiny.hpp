  ...
  void loadData() {
    ...
    for (auto &obj : gallary) {
      for (auto &mesh : obj._meshes) {
		...
		mats.push_back(Materials(glm::vec3(1.0f,0.0f,0.0f),mesh.MeshMaterial.Ns, mesh.MeshMaterial.Ka, mesh.MeshMaterial.Ni,mesh.MeshMaterial.Ks,mesh.MeshMaterial.d, mesh.MeshMaterial.illum,0.0f,0.0f,0.0f));
