  ...
  void loadData() {
    ...
    for (auto &obj : gallary) {
      for (auto &mesh : obj._meshes) {
		...
		mats.push_back(Materials(mesh.MeshMaterial.Kd,mesh.MeshMaterial.Ns, mesh.MeshMaterial.Ka, mesh.MeshMaterial.Ni,mesh.MeshMaterial.Ks,mesh.MeshMaterial.d, mesh.MeshMaterial.illum,0.0f,0.0f,0.0f));
