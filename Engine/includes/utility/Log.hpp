...
public:
  ...
  inline const std::string get_relative_log_file_path() const { return _log_file_path.string(); }
  inline const std::string get_absolute_log_file_path() const { return fs::absolute(_log_file_path).string(); }
