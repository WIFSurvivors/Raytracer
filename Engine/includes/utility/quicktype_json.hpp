...
namespace quicktype {
    ...
    class CameraComponent {
        ...
        void set_aspect_ratio(std::optional<double> value) { this->aspect_ratio = value; }
    ...
    class RenderComponent {
        ...
        void set_obj_uuid(std::optional<std::string> value) { this->obj_uuid = value; }

        std::optional<std::string> get_mat_uuid() const { return mat_uuid; }
        void set_mat_uuid(std::optional<std::string> value) { this->mat_uuid = value; }
    };
    ...
    class Components {
        ...
        public:
        std::optional<RenderComponent> get_render_component() const { return render_component; }
        void set_render_component(std::optional<RenderComponent> value) { this->render_component = value; }

        std::optional<LightComponent> get_light_component() const { return light_component; }
        void set_light_component(std::optional<LightComponent> value) { this->light_component = value; }

        std::optional<CameraComponent> get_camera_component() const { return camera_component; }
        void set_camera_component(std::optional<CameraComponent> value) { this->camera_component = value; }
    };
    ...
    class Entity {
        ...
        void set_translation(std::optional<Translation> value) { this->translation = value; }

        std::optional<Components> get_components() const { return components; }
        void set_components(std::optional<Components> value) { this->components = value; }
    };
    ...
    class Metadata {
        ...
        public:
        std::optional<std::vector<double>> get_background_color() const { return background_color; }
        void set_background_color(std::optional<std::vector<double>> value) { this->background_color = value; }

        std::optional<bool> get_global_illumination() const { return global_illumination; }
        void set_global_illumination(std::optional<bool> value) { this->global_illumination = value; }

        std::optional<std::string> get_render_mode() const { return render_mode; }
        void set_render_mode(std::optional<std::string> value) { this->render_mode = value; }
        ...
        std::optional<int64_t> get_samples_per_pixel() const { return samples_per_pixel; }
        void set_samples_per_pixel(std::optional<int64_t> value) { this->samples_per_pixel = value; }
    };
    ...
    class QuicktypeJson {
        ...
        void set_entity(std::optional<std::vector<Entity>> value) { this->entity = value; }

        std::optional<std::vector<Resource>> get_resources() const { return resources; }
        void set_resources(std::optional<std::vector<Resource>> value) { this->resources = value; }
...
namespace quicktype {
    ...
    inline void from_json(const json & j, Components& x) {
        x.set_render_component(get_stack_optional<RenderComponent>(j, "RenderComponent"));
        x.set_light_component(get_stack_optional<LightComponent>(j, "LightComponent"));
        x.set_camera_component(get_stack_optional<CameraComponent>(j, "CameraComponent"));
    }
    ...
    inline void from_json(const json & j, Metadata& x) {
        x.set_background_color(get_stack_optional<std::vector<double>>(j, "backgroundColor"));
