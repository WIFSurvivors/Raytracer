...
public:
    ...
    inline void set_new_position(glm::vec3 new_position) { _new_position = new_position; }
    inline glm::vec3 get_old_position() const { return _old_position; }
    inline void set_old_position(glm::vec3 old_position) { _old_position = old_position; }
private:
