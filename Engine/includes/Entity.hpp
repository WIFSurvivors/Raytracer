...
struct Entity : public std::enable_shared_from_this<Entity>,
  ...
  inline std::vector<std::shared_ptr<Entity>> &get_child_entities() {
    return _child_entities;
  }
  ...
  inline void set_local_position(const glm::vec3 pos) {
    _position = pos;
    _updated = true;
  }
  ...
  inline void set_local_rotation(const glm::vec3 rot) {
    _rotation = rot;
    _updated = true;
  }
  ...
  inline void set_local_scale(const glm::vec3 scale) {
    _scale = scale;
    _updated = true;
  }
